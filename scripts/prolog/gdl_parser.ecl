...
:- export(parse_gdl_term_list_string/2).
...
:- mode parse_gdl_term_list_string(++, -).
parse_gdl_term_list_string(String, TermList) :-
	string_to_lower(String, LowercaseString),
	parse_string(LowercaseString, gdl_term_list_or_nil(TermList)).
...
gdl_logsent2_right_parens(not Sentence) --> gdl_not(_), !, gdl_white_star, gdl_sentence(Sentence), gdl_white_star, gdl_right_parens.
...
gdl_relation_constant(Relation) --> gdl_constant(Relation).
