...
#ifndef FASTRAVEPLAYER_H
#define FASTRAVEPLAYER_H
...
namespace cadiaplayer {
	namespace play {
		namespace players {
			class FASTRAVEPlayer : public UCTRAVERolloutPlayer, cadiaplayer::play::kits::TilingPlayerKit
			{
			protected:
				Cost						m_score;
				Cost						m_fscore;
			...
			public:
				FASTRAVEPlayer():UCTRAVERolloutPlayer(), cadiaplayer::play::kits::TilingPlayerKit(){};
				virtual ~FASTRAVEPlayer(){};
				virtual std::string getPlayerName() {return "FAST/RAVE Combination player";};
				virtual std::string getPlayerShortName() {return "FASTRAVE";};
